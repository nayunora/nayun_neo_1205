...
basic.forever(function () {
    ...
    if (mode == 1 && (pressure_sensor < 600 && (touch_sensor1 < 180 && touch_sensor2 < 180))) {
        orange()
    }
    ...
    if (mode == 1 && pressure_sensor > 700) {
        off()
        mode += 1
        light2 = 0
    }
    if (mode == 2 && pressure_sensor < 800) {
        off()
        mode = 0
        light2 = 0
    }
